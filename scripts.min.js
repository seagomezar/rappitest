...
!function(){"use strict";angular.module("myApp",["ngRoute","ngMaterial","myApp.controllers","myApp.services"]).constant("APIURL","http://localhost:8100/news_mock.json").config(["$routeProvider","$locationProvider",function(o,n){o.when("/",{templateUrl:"news/index.html",controller:"NewsController",controllerAs:"nc"})}])}();
