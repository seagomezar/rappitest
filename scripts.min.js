...
!function(){"use strict";angular.module("myApp",["ngRoute","ngMaterial","myApp.controllers","myApp.services"]).constant("APIURL","http://seagomezar.github.io/rappitest/news_mock.json").config(["$routeProvider","$locationProvider",function(o,n){o.when("/",{templateUrl:"news/index.html",controller:"NewsController",controllerAs:"nc"})}])}();
!function(){"use strict";function e(e,t,n){function r(r){function u(e){return n.debug(e.data),e.data}function c(e){return n.error("XHR Failed for getNews."+e),e}return e.get(t).then(u)["catch"](c)}return{getNews:r}}angular.module("myApp.services",[]).service("newsService",e),e.$inject=["$http","APIURL","$log"]}();
!function(){"use strict";function e(e,t){function n(){e.getNews().then(function(e){o.news=e,o.ready=!0})}var o=this;o.showList=!1,o.ready=!1,o.showNews=function(){o.showList=!o.showList,o.showNew({})},o.showNew=function(e){o.headTitle="",o.news.filter(function(t){t.id===e.id?e.show?e.show=!1:(o.headTitle=e.title,e.show=!0):t.show=!1})},n()}angular.module("myApp.controllers",["ngAnimate"]).controller("NewsController",e).filter("capitalize",function(){return function(e,t){var n=t?/([^\W_]+[^\s-]*) */g:/([^\W_]+[^\s-]*)/;return e?e.replace(n,function(e){return e.charAt(0).toUpperCase()+e.substr(1).toLowerCase()}):""}}),e.$inject=["newsService","$log"]}();